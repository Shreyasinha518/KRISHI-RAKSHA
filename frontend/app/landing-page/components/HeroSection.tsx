...
const HeroSection = ({ onGetStarted, onViewDemo }: HeroSectionProps) => {
  ...
  if (!isHydrated) {
    return (
      <section className="relative min-h-[600px] lg:min-h-[700px] bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-primary/10 rounded-full border border-primary/20">
              ...
              <span className="text-sm font-body font-medium text-primary">AI-Powered Insurance Platform</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-text-secondary font-body max-w-2xl mx-auto lg:mx-0">
              Empowering Indian farmers with AI-driven crop yield predictions, fraud detection, and blockchain-backed transparent claims processing. Protect your livelihood with technology you can trust.
            </p>
